...
> **Source:** Adapted from [`docs/implementation/log.md`](https://github.com/visubobby/kafka/blob/trunk/docs/implementation/log.md) in `visubobby/kafka`.
> How Kafka stores partitions as segmented logs on disk, including reads, writes, and deletes.
