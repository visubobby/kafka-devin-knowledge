...
> **Source:** Adapted from [`docs/design/design.md`](https://github.com/visubobby/kafka/blob/trunk/docs/design/design.md) in `visubobby/kafka`.
> Core design rationale: motivation, persistence, efficiency, the producer/consumer model, message delivery semantics, and replication.
